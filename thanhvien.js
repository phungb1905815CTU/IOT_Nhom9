...
var introContent_slides = document.querySelectorAll(".intro_content");
console.log(introContent_slides);
...
function setValuable_intro(index,width,height,opacity,bottom) {
    ...
    introContent_slides[index].style.display = opacity;
}

window.addEventListener("load", (event) => {

    // When user click slides It change position
    for(let i = 0 ; i < container_slides.length ; ++i) {
        container_slides[i].addEventListener("click", (event) => {
            
            if(indexClickImage != -1) {
                setValuable_imagebutton(indexClickImage,"270px","370px","saturate(10%)");
                setValuable_intro(indexClickImage,"260px","auto","none","-10px");
            }
            ...
            switch(i) {
                case 0 :
                    ...
                    setValuable_intro(0,"300px","auto","block","-45px");
                    break;
                case 1 :
                    indexClickImage = 1;
                    setValuable_imagebutton(1,"300px","450px","saturate(100%)");
                    setValuable_intro(1,"300px","auto","block","-45px");
                    break;
                case 2 :
                    indexClickImage = 2;
                    setValuable_imagebutton(2,"300px","450px","saturate(100%)");
                    setValuable_intro(2,"300px","auto","block","-45px");
                    break;
                case 3 :
                    indexClickImage = 3;
                    setValuable_imagebutton(3,"300px","450px","saturate(100%)");
                    setValuable_intro(3,"300px","auto","block","-45px");
                    break;
            }
        });
    }
